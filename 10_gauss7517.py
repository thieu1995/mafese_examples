...
PATH_SAVE = "history/gauss7517"
EPOCH = 200
POP_SIZE = 50
TEST_SIZE = 0.2
ESTIMATOR = "knn"

data = get_dataset("gauss-75-17")
...
feat_selector.evaluate(estimator=ESTIMATOR, data=data, metrics=["R2", "NNSE", "MAPE"], save_path=PATH_SAVE, verbose=False)
